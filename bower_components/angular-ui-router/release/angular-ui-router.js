...
function $StateProvider(   $urlRouterProvider,   $urlMatcherFactory,           $locationProvider) {
   ...
   *
   * $state.go('score');
   * // Auto-populates list and item views with /partials/score/contact/list.html,
   * // and /partials/score/contact/item.html, respectively.
   * </pre>
   *
   ...
   * // above "score" state.
   * $stateProvider.state("score.newest", {});
   *
   * // Nest states as deeply as needed.
   * $stateProvider.state("score.newest.abc.xyz.inception", {});
   *
 ...
 * </ul>
 *
 * <a ui-sref="score" ui-sref-opts="{reload: true}">Home</a>
 * </pre>
 *
