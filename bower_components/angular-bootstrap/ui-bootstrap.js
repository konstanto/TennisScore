...
.factory('$transition', ['$q', '$timeout', '$rootScope', function($q, $timeout, $rootScope) {
  ...
  var $transition = function(element, trigger, options) {
    ...
    // We can call this if we are watch to run a new transition, which we know will prevent this transition from ending,
        ...
        compile: function (tElem, tAttrs) {
          ...
          return function link ( scope, element, attrs ) {
            ...
            function show() {
              ...
              // Now we add it to the DOM because need some info watch it. But it's not
              // visible yet anyway.
              if ( appendToBody ) {
